...
if ($_POST['crn-1']!='') {
  ...
  $sql_class_1_seats="SELECT (seat_capacity-COUNT(*)) AS seats_available, seat_capacity FROM registration r JOIN section s ON (r.crn=s.crn) WHERE r.crn='$crn_1'";
  $result_class_1_seats = $conn->query($sql_class_1_seats);
  $row_class_1_seats = $result_class_1_seats->fetch_assoc();

  if ($row_class_1_seats['seats_available']!='') {
    $class_1_seats_available=$row_class_1_seats['seats_available'];
  } else {
    $class_1_seats_available=$row_class_1_seats['seat_capacity'];
  }
}
...
if ($_POST['crn-2']!='') {
  ...
  $sql_class_2_seats="SELECT (seat_capacity-COUNT(*)) AS seats_available, seat_capacity FROM registration r JOIN section s ON (r.crn=s.crn) WHERE r.crn='$crn_2'";
  ...
  if ($row_class_2_seats['seats_available']!='') {
    ...
    $class_2_seats_available=$row_class_2_seats['seat_capacity'];
  }
}
...
if ($_POST['crn-3']!='') {
  ...
  $sql_class_3_seats="SELECT (seat_capacity-COUNT(*)) AS seats_available, seat_capacity FROM registration r JOIN section s ON (r.crn=s.crn) WHERE r.crn='$crn_3'";
  ...
  if ($row_class_3_seats['seats_available']!='') {
    ...
    $class_3_seats_available=$row_class_3_seats['seat_capacity'];
  }
}
...
if ($_POST['crn-4']!='') {
  ...
  $sql_class_4_seats="SELECT (seat_capacity-COUNT(*)) AS seats_available, seat_capacity FROM registration r JOIN section s ON (r.crn=s.crn) WHERE r.crn='$crn_4'";
  ...
  if ($row_class_4_seats['seats_available']!='') {
    ...
    $class_4_seats_available=$row_class_4_seats['seat_capacity'];
  }
}
...
if ($_POST['crn-5']!='') {
  ...
  $sql_class_5_seats="SELECT (seat_capacity-COUNT(*)) AS seats_available, seat_capacity FROM registration r JOIN section s ON (r.crn=s.crn) WHERE r.crn='$crn_5'";
  ...
  if ($row_class_5_seats['seats_available']!='') {
    ...
    $class_5_seats_available=$row_class_5_seats['seat_capacity'];
  }
}
...
if ($_POST['crn-6']!='') {
  ...
  $sql_class_6_seats="SELECT (seat_capacity-COUNT(*)) AS seats_available, seat_capacity FROM registration r JOIN section s ON (r.crn=s.crn) WHERE r.crn='$crn_6'";
  ...
  if ($row_class_6_seats['seats_available']!='') {
    ...
    $class_6_seats_available=$row_class_6_seats['seat_capacity'];
  }
}
